# Vacation Reply Bot using Node.js 
...
# Video Explaination
https://drive.google.com/file/d/1Y4ub8R6rrEPz_YGGNIBl8e6vhewarbKR/view?usp=sharing
...
1.Code efficiency: The code could be optimized to handle larger volumes of emails more efficiently.
2.Security: Ensuring that sensitive information, such as client secrets and refresh tokens, are stored
  securely and not exposed in the   code.
3.Time Monitoring: The code currently use randominterval function to generate seconds and in this code can be improved by adding cron jobs package to schedule email tasks 
